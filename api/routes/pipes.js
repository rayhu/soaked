...
router.put('/', (req, res) => {
    ...
    if ((id1.listenerCount('message') >= 2) || (id2.listenerCount('message') >= 2))
    {
        return res.status(500).send(`There is already pipelines on ${req.body.client1} or ${req.body.client2}`)        
    }
